...
// 	const activeYear =
// 		selectedYear === "All"
// 			? new Date().getFullYear() // fallback, or use min/max in data for "All"
// 			: parseInt(selectedYear, 10);

// 	const monthsInYear = Array.from({ length: 12 }, (_, idx) =>
// 		new Date(activeYear, idx).toLocaleDateString("en-US", {
// 			month: "short",
// 			year: "numeric",
// 		})
// 	);
...
// 		releasesByMonth[item.month] = item.count; // assumes 'month' is 'Jan 2023' etc
// 	});

// 	// Create the final chart data, filling 0 if missing
