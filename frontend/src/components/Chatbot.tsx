    ...
    >
      ...
      >
        <input
          ...
          className="flex-1 px-3 py-2 border text-black rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:text-white"
          autoFocus
        />
        <button
          type="submit"
